            ...
            <div class="fixed-bottom">
                ...
                <a href="index.php?p=resultat" class="text-white text-decoration-none">
                    <div class="button-bleu text-center">
                        <p class="text-button" style="font-size: 27px;"><strong>Arreter mon parcours</strong> <img src="web/Images/fleche.svg" alt=""></p>
                    </div>
                </a>
            </div>
    ...
    <div class="modal-dialog m-0  text-white text-center" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-1 bg-dark ">
                ...
                <p>Cette carte te permettra de t’orienter sur le site de Tout Angers Bouge. Les 15 disciplines à essayer sont représentées par des marqueurs noirs. Ta mission si tu l’acceptes : Défier tes amis, tester un maximum de sports afin de découvrir quel Dalleux sommeille en toi, partager ton expérience et gagner des récompenses. </p>
                <div class="oblique-top mx-auto">
                </div>

                    <a class="btn btn-light text-decoration-none rounded-0" data-dismiss="modal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-1 bg-dark ">
                    ...
                    <div class="defi">
                        ...
                        <a href="" class="text-white">Défier quelqu'un</a>
                    </div>
                    <div class="oblique-top mx-auto">
                    </div>
                    ...
                    <a class="btn btn-light text-decoration-none rounded-0" data-dismiss="modal">
                        ...
                        <div class="button-white text-center">
                            <p class="text-dark mb-0" ><strong>Sport testé </strong>
                                </p><img src="web/images/valider.svg" alt="">
                        </div>
