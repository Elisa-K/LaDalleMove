<div class="container-fluid h-100 pt-4 bg-bleu">
	<div class="row h-100">
		<div class="col-12 h-100">
            <div class="accueil-header">
                <h2 class="text-center">Bienvenue sur</h2>
                <h1 class="text-center TitreLaDalleMove">#LaDalleMove !</h1>
                ...
                <div class="h-100 img-home2"></div>
<!--                <img src="web/Images/image_home.png" alt="" class="img-home2 mx-auto d-block">-->
                <p class="text-center TexteDescriptifAccueil mt-4 mb-0" style="font-size: 1rem;">Es-tu prêt ?</p>
            </div>
